export const options = {
  ...
  history: {
    "anise": "Anise, (Pimpinella anisum), annual herb of the parsley family (Apiaceae), cultivated chiefly for its fruits, called aniseed, the flavor of which resembles that of licorice. Native to Egypt and the eastern Mediterranean region, anise is cultivated in southern Europe, southern Russia, the Middle East, North Africa, Pakistan, China, Chile, Mexico, and the United States. Star anise, an unrelated plant, has a similar flavor profile.",
    ...
    "basil": "Basil, (Ocimum basilicum), also called sweet basil, annual herb of the mint family (Lamiaceae), grown for its aromatic leaves. Basil is likely native to India and is widely grown as a kitchen herb. The leaves are used fresh or dried to flavor meats, fish, salads, and sauces; basil tea is a stimulant.",
    ...
    "honey": "Honey, sweet, viscous liquid food, dark golden in color, produced in the honey sacs of various bees from the nectar of flowers. Flavour and color are determined by the flowers from which the nectar is gathered. Some of the most commercially desirable honeys are produced from clover by the domestic honeybee.",
    ...
    "liver": "The Babylonians considered the liver to be the seat and mirror of the soul and, as a consequence, this organ became the focus of divination ceremonies, in which the livers of sacrificial animals were carefully inspected by priests for signs of damage prior to being offered as gifts to the gods. It was the Greeks who first abandoned superstition in favor of an approach to the understanding of the body based on anatomy and physiology, and it is in the writings of Aristotle where the first attempts to describe animals' livers based on dissection are to be found.",
    ...
    "sauce": "Sauce, liquid or semiliquid mixture that is added to a food as it cooks or that is served with it. Sauces provide flavor, moisture, and a contrast in texture and color. They may also serve as a medium in which food is contained, for example, the velouté sauce of creamed chicken. Seasoning liquids (soy sauce, hot pepper sauce, fish sauce, Worcestershire sauce) are used both as ingredients in cooking and at the table as condiments.",
    ...
    "sushi": "Sushi, a staple rice dish of Japanese cuisine, consisting of cooked rice flavored with vinegar and a variety of vegetable, egg, or raw seafood garnishes and served cold. Restaurants specializing in sushi abound in Japan, where subtleties of preparation find a discriminating clientele. ",
    ...
    "thyme": "Thyme, (Thymus vulgaris), pungent herb of the mint family (Lamiaceae) known for the aroma and flavor of its dried leaves and flowering tops. Thyme is native to Eurasia and is cultivated throughout the world. It is used to flavor a wide range of foods, including poultry, stuffings, fish, eggs, meats, sauces, soups, vegetables, cheeses, and pastas.",
